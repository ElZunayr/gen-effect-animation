<h1 align="center">GEN EFFECT ANIMATION</h1>
<h3 align="center">GEN EFFECT ANIMATION | HTML, CSS, & JAVASCRIPT</h3>
...
- [Demo](https://elzunayr.github.io/gen-effect-animation/)

## 🚀 Getting started

If you installed git you can clone the code to your machine, or download a ZIP of all the files directly.
[Download the ZIP from this location](https://github.com/ElZunayr/gen-effect-animation.git), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:
```bash
git clone https://github.com/ElZunayr/gen-effect-animation.git
```
